...
{
    public class BorrowChangeStatusToShippedEventHandler : IEventHandler<BorrowChangeStatusToShippedEvent>
    {
        private readonly IHubContext<NotificationHub> _context;
        private readonly ILogger<BorrowChangeStatusToShippedEventHandler> _logger;
        public BorrowChangeStatusToShippedEventHandler(IHubContext<NotificationHub> context, 
            ILogger<BorrowChangeStatusToShippedEventHandler> logger)
        {
            _context = context;
            _logger = logger;
        }

        public async Task Handler(BorrowChangeStatusToShippedEvent @event)
        {
