...
{
    public class BorrowChangeStatusToCancelledEventHandler : IEventHandler<BorrowChangeStatusToCancelledEvent>
    {
        private readonly IHubContext<NotificationHub> _context;
        private readonly ILogger<BorrowChangeStatusToCancelledEventHandler> _logger;
        public BorrowChangeStatusToCancelledEventHandler(IHubContext<NotificationHub> context, ILogger<BorrowChangeStatusToCancelledEventHandler> logger)
        {
            _context = context;
            _logger = logger;
        }

        public async Task Handler(BorrowChangeStatusToCancelledEvent @event)
        {
