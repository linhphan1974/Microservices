...
using BookOnline.Basket.Api.GrpcService;
using BookOnline.Basket.Api.Infrastructure;
using BookOnline.Basket.Api.Infrastructure.Data;
using BookOnline.Basket.Api.Infrastructure.EventHandlers;
...
{
    var queueName = "BasketAPI";//configuration["QueueName"];
...
builder.Services.AddTransient<BorrowCreatedEventHandler>();
...
{
    options.AddPolicy("basket", policy =>
    {
...
eventBus.Subcribe<BorrowCreatedEvent, BorrowCreatedEventHandler>();
